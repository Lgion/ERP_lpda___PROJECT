...
const catchError = (res: any, error: any) => res.status(500).json({ error });
const catchErrorCustom1 = (res: any, error: any) => res.status(500).json({ error, message: "customize an error message HERE" });
